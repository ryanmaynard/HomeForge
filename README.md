...
A modern, modular personal dashboard platform built with React, Vite, and Netlify.
...
- **Dark Mode** - Dark theme with toggle
...
- **Loading Skeletons** - Type-specific loading states for better performance
- **API Caching** - Intelligent caching reduces redundant API calls
...
- **Extensible** - Add new widgets with clear patterns
- **Optimized** - Built with Vite for fast load times
...
Made with care by the HomeForge community
